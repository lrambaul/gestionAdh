...
/* accueil/structure/listeGroupesStructure.html.twig */
class __TwigTemplate_99ce670ae550f57765019d43ddfcf5235f4bc3730f247250d43b071715b41224 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "accueil/structure/listeGroupesStructure.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "accueil/structure/listeGroupesStructure.html.twig"));

        $this->parent = $this->loadTemplate("accueil/structure/homestructure.html.twig", "accueil/structure/listeGroupesStructure.html.twig", 1);
        ...
        ";
            ...
            echo "
                        ...
                        <button>
                            <a href=\"";
            // line 18
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("AjoutGroupe", ["idAsso" => twig_get_attribute($this->env, $this->source, $context["association"], "getId", [], "method", false, false, false, 18), "NumReturn" => 2]), "html", null, true);
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["groupe"]) {
                ...
                echo "   <a href=\"";
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("modifprofilGroupeAsso", ["idGroupe" => twig_get_attribute($this->env, $this->source, $context["groupe"], "getId", [], "method", false, false, false, 28), "NumReturn" => 2]), "html", null, true);
                ...
                echo ".Inter\" role=\"tabpanel\" aria-labelledby=\"Intervenant-tab\">
                                    ...
                                    <a href=\"";
                // line 49
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("ListeIntervenantGroupeStruct", ["idGroupe" => twig_get_attribute($this->env, $this->source, $context["groupe"], "getId", [], "method", false, false, false, 49)]), "html", null, true);
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["intervenant"]) {
                    ...
                    echo "</td>
                                                ...
                                                <td>
                                                    <a href=\"";
                    // line 76
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("modifprofilIntervenantpourAsso", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["intervenant"], "getPersonne", [], "method", false, false, false, 76), "getId", [], "method", false, false, false, 76), "NumReturn" => 4]), "html", null, true);
                    echo "\" method=\"post\">Modifier</a>
                                                </td>
                                                <td>
                                                    <a href=\"";
                    // line 79
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("supprInterGroupe", ["idInter" => twig_get_attribute($this->env, $this->source, $context["intervenant"], "id", [], "any", false, false, false, 79), "idGroupe" => twig_get_attribute($this->env, $this->source, $context["groupe"], "getId", [], "method", false, false, false, 79), "NumReturn" => 2]), "html", null, true);
                ...
                echo ".Adh\" role=\"tabpanel\" aria-labelledby=\"Adherent-tab\">
                                   ...
                                   <a href=\"";
                // line 94
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("ListeAdhGroupeStruct", ["idGroupe" => twig_get_attribute($this->env, $this->source, $context["groupe"], "getId", [], "method", false, false, false, 94)]), "html", null, true);
                ...
                echo ".suppression\" role=\"tabpanel\" aria-labelledby=\"home-tab\">
                                    ...
                                    <a href=\"";
                // line 151
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("SupprGroupeAsso", ["idGroupe" => twig_get_attribute($this->env, $this->source, $context["groupe"], "getId", [], "method", false, false, false, 151), "NumReturn" => 2]), "html", null, true);
...
";
    ...
    {
        return "accueil/structure/listeGroupesStructure.html.twig";
    }
            ...
            <div class=\"card\">
                <div class=\"card-header\" id=\"headingOne\">
                    ...
                    <h5 class=\"mb-0\">
                        ...
                        <button>
                            <a href=\"{{ path('AjoutGroupe',{'idAsso': association.getId(), 'NumReturn': 2})}}\" method=\"post\">Ajouter un Groupe</a>
                        </button>
                    </h5>
                </div>
                ...
                <div id=\"{{association.getNomAsso()}}\" class=\"collapse\" aria-labelledby=\"headingOne\" data-parent=\"#accordion\">
                    <div class=\"card-body\">
                        ...
                        {% for groupe in association.getGroupes() %}
                            Pour le groupe : {{groupe.getNomGroupe()}}   <a href=\"{{ path('modifprofilGroupeAsso',{'idGroupe': groupe.getId(), 'NumReturn': 2})}}\" method=\"post\">Modifier le nom du groupe</a>
                            {#Début de la nav-tab#}
                            ...
                            <div class=\"tab-content\">
                                ...
                                <div class=\"tab-pane active\" id=\"{{association.getNomAsso()}}.{{ groupe.getNomGroupe()}}.Inter\" role=\"tabpanel\" aria-labelledby=\"Intervenant-tab\">
                                    ...
                                    <a href=\"{{ path('ListeIntervenantGroupeStruct',{'idGroupe': groupe.getId()})}}\" method=\"post\">Ajouter un intervenant</a>
                                    ...
                                    <table id=\"\" class=\"display\" style=\"width:100%\">
                                        ...
                                        {% for intervenant in groupe.getIntervenants() %}
                                            <tr>
                                                ...
                                                <td>
                                                    <a href=\"{{ path('modifprofilIntervenantpourAsso',{'id': intervenant.getPersonne().getId(),'NumReturn': 4}) }}\" method=\"post\">Modifier</a>
                                                </td>
                                                <td>
                                                    <a href=\"{{ path('supprInterGroupe',{'idInter': intervenant.id,'idGroupe': groupe.getId(),'NumReturn': 2}) }}\" method=\"post\">Supprimer</a>
                                                </td>
                                ...
                                <div class=\"tab-pane\" id=\"{{association.getNomAsso()}}.{{ groupe.getNomGroupe()}}.Adh\" role=\"tabpanel\" aria-labelledby=\"Adherent-tab\">
                                   ...
                                   <a href=\"{{ path('ListeAdhGroupeStruct',{'idGroupe': groupe.getId()})}}\" method=\"post\">Ajouter un adhérent</a>
                                    ...
                                    <table id=\"\" class=\"display\" style=\"width:100%\">
                                        ...
                                        {% for adherent in groupe.getAdherents() %}
                                            <tr>
                                                ...
                                                <td>
                                                    <a href=\"{{ path('modifprofilAdherentpourAsso',{'id': adherent.getPersonne().getId(), 'NumReturn': 4}) }}\" method=\"post\">Modifier</a>
                                                </td>
                                                <td>
                                                    <a href=\"{{ path('supprAdhGroupe',{'idAdh': adherent.id,'idGroupe': groupe.getId(), 'NumReturn': 2}) }}\" method=\"post\">Supprimer</a>
                                                </td>
                                ...
                                <div class=\"tab-pane\" id=\"{{association.getNomAsso()}}.{{ groupe.getNomGroupe()}}.suppression\" role=\"tabpanel\" aria-labelledby=\"home-tab\">
                                    ...
                                    <br>
                                    <br>
                                    <a href=\"{{ path('SupprGroupeAsso',{'idGroupe': groupe.getId(), 'NumReturn': 2})}}\" class=\"btn btn-primary\" method=\"post\">Supprimer le groupe</a>
                                    <br>
                                    <br>
                                    <br>
                                    <br>
...
{% endblock %}", "accueil/structure/listeGroupesStructure.html.twig", "C:\\Users\\USER\\Desktop\\gestadh_awa\\new_awa_project(fusion)\\gestion\\templates\\accueil\\structure\\listeGroupesStructure.html.twig");
    }
}
